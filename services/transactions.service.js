...
const TransactionService = {
    ...
    async createTransaction(user_id1, user_id2, total, splitAmount, date, description) {
        ...
        try {
            ...
            console.log('Creating Transaction Data:', data);
    ...
    async getTransactionsByFilter(filter) {
        try {
            ...
            throw new Error('Error fetching Transactions by filter');
        }
